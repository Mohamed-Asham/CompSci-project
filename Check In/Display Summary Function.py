...
def display_summary_info_system():
    """
    Encapsulates the user display system, allowing viewing and summarizing user details.
    """
    class User:
    ...
    def view_user_details(user):
        """Display detailed summary information for a selected user."""
    ...
    def display_user_list(users):
        """Display a list of users and allow the user to select one to view details."""
        while True:
            print("\nUsers List:")
