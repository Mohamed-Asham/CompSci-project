...
def draw_mood_tracker(email_address):
    ...
    screen.onclick(lambda x, y: on_click(x, y, screen))

    screen.mainloop()

    print("[ 1 ] Add comments to the journal")
    print("[ S ] Submit and return to Main menu ")
    while True:
        ...
        if ch == "1":
            ...
            print("Please choose a valid input '1' or S")
def journal_page(email_address):
    while True:
        ...
        if choice == "1":
            draw_mood_tracker(email_address)
        elif choice == "2":
...
def new_journal_entry(email_address):
    ...
    entry_line = [f"I am feeling: {selected_mood}.\n"]
    while True:
        line = input()
